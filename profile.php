		...
		<div class="row">
			<div class="col-md-3">
			   ...
			   <div class="menu">
			   	<ul>
			   		...
			   		<li class="active"><a href="profile.php"><i class="fa fa-desktop" style="font-size: 25px; margin-left: 10px">&nbsp;</i>Change Password</a></li>
			   	</ul>
			   </div>
			</div>
			<div class="col-md-9" style="background: rgba(51,51,51,0.03);">
				...
				<div class="container" style="background: white; border: 0px solid; width: 800px;">
					...
					<label for="name">Write your Old Password</label>
					<input required  type="text" name="name" id="name" class="form-control">	
					<br>
					<label for="name">Write your New Password</label>
					<input required  type="text" name="name" id="name" class="form-control">	
					<br>
					<label for="name"> Rewrite your New Password</label>
					<input required  type="text" name="name" id="name" class="form-control">	
					<br>
