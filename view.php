		...
		<div class="row">
			...
			<div class="col-md-9" style="background: rgba(51,51,51,0.03);">
				...
				<div class="container" style="background: white; border: 0px solid; width: 800px;">
					<h3>Insert/View News</h3>
					<h6 style="font-weight: bold;">Total News <span class="badge">4</span></h6>
					<hr>
					<a href="insertnews.php" class="btn btn-info" style="float: right;" >Insert News</a>	
